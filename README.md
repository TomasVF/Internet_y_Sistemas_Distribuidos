...
### Running the es.udc.ws.app.client.service with Maven/Jetty

	cd ws-app-es.udc.ws.app.client.service
	mvn jetty:run

### Running the es.udc.ws.app.client.service with Tomcat

- Copy the `.war` file (`ws-app-es.udc.ws.app.client.service/target/ws-app-es.udc.ws.app.client.service.war`)
